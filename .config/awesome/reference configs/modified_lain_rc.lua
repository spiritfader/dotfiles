...
-- awful.spawn.with_shell( -- This function implements the XDG autostart specification
...
globalkeys = mytable.join(
    ...
    awful.key({ modkey }, "e", function () awful.spawn(terminal .. " -e ranger") end,                         -- launch ranger file explorer
